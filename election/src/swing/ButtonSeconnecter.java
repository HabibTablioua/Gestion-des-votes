...
public class ButtonSeconnecter extends JButton {
    ...
    private Color color1 = Color.decode("#006666");
    ...
    private float sizeSpeed = 0f;
    private float alphaPressed = 0.5f;
    private Font buttonFont;


    public ButtonSeconnecter() {
        setContentAreaFilled(false);
        setForeground(Color.BLACK);
        setCursor(new Cursor(Cursor.HAND_CURSOR));
        setBorder(new EmptyBorder(10, 20, 10, 20));
        buttonFont = new Font("Vladimir Script", Font.PLAIN, 24);  // You can adjust the size (18) as needed
        setFont(buttonFont);
